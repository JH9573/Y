...
CB_PANEL_NOTICE_SHOW = "pnnts:"  # pnnts:<panel_id>:<page>:<notice_id> -> 翻转发布状态
CB_PANEL_NOTICE_DEL = "pnntx:"  # pnntx:<panel_id>:<page>:<notice_id> -> 删除二次确认
CB_PANEL_NOTICE_DEL_OK = "pnntxok:"  # pnntxok:<panel_id>:<page>:<notice_id> -> 真正删除
CB_PANEL_NOTICE_ADD = "pnnta:"  # pnnta:<panel_id> -> 发布新公告(会话入口)
CB_PANEL_NOTICE_EDIT = "pnnte:"  # pnnte:<panel_id>:<page>:<notice_id> -> 编辑公告(会话入口)
